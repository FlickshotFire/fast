...
const ProductsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Button
            variant="ghost"
            onClick={() => navigate('/')}
            className="mb-8 text-green-400 hover:text-green-300"
          >
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 rounded-full glass border border-green-500/30 mb-6">
              <ShoppingBag className="w-4 h-4 text-green-400 mr-2" />
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-r from-green-950/30 to-blue-950/30">
